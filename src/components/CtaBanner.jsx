...
const CtaBanner = () => {
    ...
    return (
        <div className="bg-light data-nosnippet py-6 my-5 px-3 rounded-lg">
            <div className="container mx-auto flex items-center justify-between">
                {/* <p className="text-white text-lg">Need help with your ProctorU exam? Chat with us!</p> */}
                <p className="text-dark text-xl md:text-2xl font-bold basis-10/12">Finding it hard to crack ProctorU exams? Hire Us! </p>
